...
<!-- Descreva de forma concisa o que foi feito nesta alteração -->

## Tipo de Alteração

- [ ] `feat`: Nova funcionalidade ou seção
- [ ] `fix`: Correção de bug ou layout
- [ ] `docs`: Atualização de documentação
- [ ] `style`: Ajuste de CSS / Tokens sem alteração de lógica
- [ ] `refactor`: Refatoração interna
- [ ] `chore`: Lançamento de versão ou atualização de dependências

## Agente / Autor Responsável
